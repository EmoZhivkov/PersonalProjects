...
public class SuvFactoryWithTwoArg implements VehicleFactory {
    ...
    public SuvFactoryWithTwoArg(Map<Integer, Model> modelSuvSetter, Map<Integer, Transmission> transmissionSetter,
     ...
     */
    @Override
    public Suv createVehicle(String input, String vin) throws EngineNotSupportedException, ModelNotSupportedException{
