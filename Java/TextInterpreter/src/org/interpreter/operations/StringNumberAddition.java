...
public class StringNumberAddition extends Interpreter implements Operation {
    VariableContainer variableContainer;

    public StringNumberAddition(VariableContainer variableContainer) {
    ...
    public void execute(String input) {
        ...
        String current = (String) this.variableContainer.getValue(firstVarToAdd) + this.variableContainer.getValue(secondVarToAdd);
