...
class Database {
    ...
    function add_user($user) {
        try {
            $sql = "INSERT INTO Users (first_name, second_name, course_year, course_name, fn, group_number, birth_date, zodiac_sign, link) VALUES (:first_name, :second_name, :course_year, :course_name, :fn, :group_number, :birth_date, :zodiac_sign, :link)";
